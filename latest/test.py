...
#    f.close
#
#    DateiListe1 = list(delZeichen)
#    DateiListe2=DateiListe1[:-1]
#    ZeichenDel = str(DateiListe2)
#
#    f = open(FormelPfad, "w")
#    f.write(ZeichenDel)
#    f.close()
#     
#    s = display_text.get()
#    VorschauListe1 = list(s)
#    print(VorschauListe1)
#    VorschauListe2 = VorschauListe1[:-1]
#    print(VorschauListe2)
#
#    display_text.set(VorschauListe2)
...
#buttong = tk.Button(window, text="Lösche letztes Zeichen", height=5, width=15, command=LoescheLetzte)
#buttong.grid(row=2, column=7)
